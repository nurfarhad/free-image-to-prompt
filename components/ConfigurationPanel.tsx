  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel p-4 space-y-4">
         ...
         <div className={cn(
             "flex items-center justify-between bg-zinc-950 p-4 rounded-2xl border border-white/5 group hover:border-amber-500/30 transition-all",
             isCharacterBuilderMode && "border-amber-500/50 animate-gemini-glow"
         )}>
            <div className="flex items-center gap-3">
