...
const GeneratedImage: React.FC<GeneratedImageProps> = ({ imageUrl, isLoading, error, onDownload, onGenerate }) => {
  ...
  return (
    <>
        ...
        <div className="relative flex-1 w-full flex items-center justify-center rounded-xl overflow-hidden bg-brand-dark/50 border border-gray-800/50 shadow-inner min-h-[250px]">
            ...
            <div className="relative w-full h-full flex items-center justify-center group bg-[url('https://www.transparenttextures.com/patterns/dark-matter.png')]">
                ...
                <div className="text-center p-4 max-w-xs">
                    <div className="w-12 h-12 rounded-full bg-red-500/10 border border-red-500/20 mx-auto mb-3 flex items-center justify-center text-red-400">
                    ...
                    <p className="text-[11px] text-zinc-400 leading-relaxed break-words">{error}</p>
                </div>
            ) : (
        ...
        {isLightboxOpen && imageUrl && createPortal(
            <div className="fixed inset-0 z-[9999] bg-black/95 backdrop-blur-md flex items-center justify-center animate-fade-in p-4">
                <div className="relative w-full h-full max-w-7xl flex items-center justify-center">
                    <button 
                        onClick={() => setIsLightboxOpen(false)}
                        className="absolute top-4 right-4 z-[10000] p-3 bg-gray-800/50 hover:bg-gray-700 text-white rounded-full transition-colors"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-4 z-[10000]">
                        <button
                            onClick={onDownload}
