...
const GazeSelector: React.FC<GazeSelectorProps> = ({ onSelect, disabled }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 p-1 w-full h-full">
      ...
      <div className="grid grid-cols-3 gap-1 mt-auto mb-auto">
        ...
        <div className="col-start-2">
            <ControlButton label="Look Up" gaze="looking up" className="w-7 h-7" icon={<EyeIcon transform="translate(0, -1.5)" />} />
        </div>

        {/* Left */}
        <div className="col-start-1 row-start-2">
            <ControlButton label="Look Left" gaze="looking left" className="w-7 h-7" icon={<EyeIcon transform="translate(-1.5, 0)" />} />
        </div>
        
        {/* Center / Camera */}
        <div className="col-start-2 row-start-2">
            <ControlButton label="Look at Camera" gaze="looking directly at the camera" className="w-7 h-7 bg-brand-primary/10 border-brand-primary/30 text-brand-primary" icon={
        ...
        <div className="col-start-3 row-start-2">
             <ControlButton label="Look Right" gaze="looking right" className="w-7 h-7" icon={<EyeIcon transform="translate(1.5, 0)" />} />
        </div>

        {/* Down */}
        <div className="col-start-2 row-start-3">
             <ControlButton label="Look Down" gaze="looking down" className="w-7 h-7" icon={<EyeIcon transform="translate(0, 1.5)" />} />
        </div>
      </div>

       <div className="w-full h-px bg-gray-800 my-1"></div>
       
       <ControlButton label="Look Away / Candid" gaze="looking away from camera" className="w-full h-7" icon={
            <div className="flex items-center gap-1">
                <span className="text-[8px] font-bold">CANDID</span>
