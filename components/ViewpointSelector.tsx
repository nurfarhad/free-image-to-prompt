    ...
    <div className="flex flex-col items-center gap-4 p-2 w-full">
      ...
      <div className="grid grid-cols-3 gap-1">
        ...
        <div className="col-start-2">
            <ControlButton label="Top View" view="Top-down / Overhead" className="w-8 h-8" icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7m0 0l7 7" /></svg>
            } />
        </div>

        {/* Row 2 */}
        <div className="col-start-1 row-start-2">
            <ControlButton label="Left Profile" view="Left Side Profile" className="w-8 h-8" icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            } />
        </div>
        <div className="col-start-2 row-start-2">
            <ControlButton label="Front View" view="Front View" className="w-8 h-8 bg-gray-800/50" icon={
                <div className="w-2 h-2 rounded-full bg-current"></div>
            } />
        </div>
        <div className="col-start-3 row-start-2">
            <ControlButton label="Right Profile" view="Right Side Profile" className="w-8 h-8" icon={
        ...
        <div className="col-start-2 row-start-3">
            <ControlButton label="Bottom View" view="Bottom-up / Low Angle" className="w-8 h-8" icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7-7-7" /></svg>
            } />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 w-full px-1">
         <ControlButton label="Isometric View" view="Isometric View" className="w-full h-8 flex space-x-2" icon={
             <>
         ...
         <ControlButton label="Back View" view="Back View" className="w-full h-8" icon={
