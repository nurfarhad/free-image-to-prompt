...
import { generatePromptFromImage, generatePromptVariations, PromptOptions, PromptData, exportToCSV, exportToJSON, resizeBase64 } from '../services/geminiService';
    ...
    const processQueue = async () => {
        ...
        for (const item of itemsToProcess) {
            ...
            try {
                ...
                const resizedBase64 = await resizeBase64(rawBase64, 1280);
                ...
                const imagePart = {
                    inlineData: { data: resizedBase64, mimeType }
                };
